      ...
      <div class="col-2">
        ...
        <form action="<?= $destino ?>" method="post">
          <div class="mb-3">
            ...
            <input readonly name="id" type="text" value="<?php echo isset($areas) ? $areas['id'] : "" ?>"
              class="form-control">
          </div>

          <div class="mb-3">
            <label class="form-label"> Nome </label>
            <input name="nome" type="text" autofocus value="<?php echo isset($areas) ? $areas['nome'] : "" ?>"
              class="form-control">
          </div>
            ...
            while ($coluna = mysqli_fetch_assoc($dados)) {
              ...
              <tr>
                ...
                <td>
                  ...
                  <a href="<?php echo "./backend/area/excluir.php?id=" . $coluna['id'] ?>"
